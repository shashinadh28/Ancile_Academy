  ...
  return (
    <>
      <PageBanner
        ...
        subtitle="Explore the world's best countries for international education and find your perfect fit."
      ...
      <SectionWrapper>
        <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {COUNTRIES.map((country, i) => (
            <div
              key={country.slug}
              className={`transition-all duration-700 ease-out ${gridInView ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-12 scale-95'}`}
            ...
            >
              ...
              >
                ...
                <div className="p-6">
                  <p className="text-gray-600 mb-4 line-clamp-2">{country.tagline}</p>
                  <div className="grid grid-cols-3 gap-3 mb-5">
                    {Object.entries(country.stats).map(([key, value]) => (
                      <div key={key} className="text-center bg-gray-50 rounded-xl p-2.5">
