  ...
  return (
    <a
      ...
      style={{
        ...
        width: hovered ? '140px' : '42px',
        borderRadius: hovered ? '34px' : '50%',
        textDecoration: 'none',
    ...
    >
      ...
      >
        <svg
          viewBox="0 0 16 16"
          style={{ width: '20px', height: '20px', fill: 'white', flexShrink: 0 }}
        >
