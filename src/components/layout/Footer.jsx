    ...
    <footer className="bg-gray-900 text-gray-400">
      <div className="container-custom px-4 sm:px-6 lg:px-8 pt-14 md:pt-20 pb-8">
        <div ref={colsRef} className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-12">
          {/* Brand */}
          <div
            className={`col-span-2 md:col-span-3 lg:col-span-2 transition-all duration-700 ease-out ${colsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="text-[10px] font-medium text-gray-500 tracking-widest uppercase">Academy</span>
              </div>
            </Link>
            ...
            <div className="space-y-2 text-sm">
              <a href="mailto:info@ancileacademy.com" className="flex items-center gap-2 text-gray-400 hover:text-primary-400 transition-colors">
                <Mail size={14} /> info@ancileacademy.com
              </a>
              <a href="tel:+911234567890" className="flex items-center gap-2 text-gray-400 hover:text-primary-400 transition-colors">
                <Phone size={14} /> +91 123 456 7890
              </a>
              <div className="flex items-start gap-2">
                <MapPin size={14} className="mt-0.5 shrink-0" />
                <span>123 Education Lane, New Delhi 110001</span>
              </div>
            </div>
          </div>
              ...
              <ul className="space-y-2.5">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      to={link.path}
                      className="text-sm text-gray-500 hover:text-primary-400 transition-colors inline-flex items-center gap-1 group"
                    >
                      {link.label}
