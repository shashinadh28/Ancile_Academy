...
const variants = {
  ...
  'outline-blue': 'border-2 border-primary-600 text-primary-600 hover:bg-primary-600 hover:text-white',
...
export default function Button({
  ...
  if (href) return <a href={href} className={baseClasses} {...props}>{children}</a>;
