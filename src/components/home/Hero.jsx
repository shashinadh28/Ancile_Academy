...
export default function Hero() {
  ...
  return (
    <>
              ...
              <AnimateIn animation="fadeUp" delay={400}>
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative">
                    <span className="absolute -top-3 -left-1 bg-primary-100 text-primary-700 text-[11px] font-semibold px-3 py-0.5 rounded-full">
      ...
      {/* Stats Bar */}
      <div className="bg-gradient-to-r from-gray-50 via-primary-50/40 to-gray-50 border-y border-gray-100">
        <div
          ref={statsRef}
          className="container-custom px-4 sm:px-6 lg:px-8 py-8 md:py-10"
        >
